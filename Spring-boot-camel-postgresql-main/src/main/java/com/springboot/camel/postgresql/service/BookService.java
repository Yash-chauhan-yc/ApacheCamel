...
public class BookService {
    ...
    public Book updateBook(int bookId, Book updatedBook) {
        ...
        if (optionalBook.isPresent()) {
            ...
            // Update the existing book properties with the updatedBook properties
            ...
            // Handle book not found scenario, throw an exception or return null/throw custom exception
